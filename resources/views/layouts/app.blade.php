            ...
            <nav>
                <ul>
                    ...
                    @if(Auth::guard('web')->check() && Auth::guard('web')->user()->level_id == 1)
                        ...
                        <li>
                            <a href={{ route('admin.users.index') }} class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 mb-2">
                        ...
                        <li>
                         ...
                         <li>
        <a href="{{ route('admin.tagihans.index') }}" class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 mb-2">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
            <span class="whitespace-nowrap">Manajemen Tagihan</span>
        </a>
    </li>
    <li>
        <a href="{{ route('admin.pembayarans.index') }}" class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 mb-2">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2m-6-6L21 3m0 0l-5.5 5.5M21 3H15m6 0v6"></path></svg>
