                    ...
                    <td class="py-2 px-4 border-b text-center">
                        @if($tagihan->status_tagihan == 'Lunas' && $tagihan->pembayaran)
                            <button onclick="showPaymentDetail(
                                ...
                                '{{ $tagihan->pembayaran->user->nama_user ?? 'Admin/Petugas' }}'
                            )" class="bg-blue-500 hover:bg-blue-700 text-white text-sm py-1 px-3 rounded-md">
                                Lihat Pembayaran
                            </button>
                        @else
                            <span class="text-gray-500 text-sm">Belum Ada Pembayaran</span>
                        @endif
                    </td>
                </tr>
                @empty
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="mt-2 px-7 py-3">
                <p class="text-sm text-gray-500 text-left"><strong>Tanggal Bayar:</strong> <span id="modalTanggalBayar"></span></p>
                <p class="text-sm text-gray-500 text-left"><strong>Total Tagihan:</strong> <span id="modalTotalTagihan"></span></p>
                <p class="text-sm text-gray-500 text-left"><strong>Biaya Admin:</strong> <span id="modalBiayaAdmin"></span></p>
                <p class="text-sm text-gray-500 text-left mt-2 font-bold"><strong>Total Dibayar:</strong> <span id="modalTotalDibayar" class="text-blue-700 text-lg"></span></p>
