...
<div class="bg-white p-6 rounded-lg shadow-md w-full max-w-lg mx-auto">
    <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Tambah User Baru</h1>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nama_user" name="nama_user" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('nama_user') border-red-500 @enderror" value="{{ old('nama_user') }}" required autofocus>
            @error('nama_user')
