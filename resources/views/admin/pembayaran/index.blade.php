            ...
            @forelse ($pembayarans as $pembayaran)
                <tr>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        {{ $pembayaran->pelanggan->nama_pelanggan ?? 'N/A' }}
                    </td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        {{ $pembayaran->user->nama_user ?? 'N/A' }}
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="6" class="px-5 py-5 text-center bg-white text-sm">Tidak ada data pembayaran.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
