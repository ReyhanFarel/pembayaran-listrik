...
@section('content')
    ...
    <div class="bg-white p-8 rounded-none border-4 border-neutral-900 neo-brutal-shadow-black w-full max-w-lg mx-auto">
        <h1 class="text-4xl font-extrabold text-neutral-900 mb-8 text-center uppercase">Edit Pelanggan</h1>
        ...
        <form action="{{ route('admin.pelanggans.update', $pelanggan->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nama_pelanggan" name="nama_pelanggan"
                    ...
                    value="{{ old('nama_pelanggan', $pelanggan->nama_pelanggan) }}" required autofocus>
            ...
            <div class="mb-6">
                <label for="password" class="block text-neutral-900 text-base font-bold mb-3 uppercase">Password (isi jika
