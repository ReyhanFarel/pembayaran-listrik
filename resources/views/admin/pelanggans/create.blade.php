...
<div class="bg-white p-6 rounded-lg shadow-md w-full max-w-lg mx-auto">
    <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Tambah Pelanggan Baru</h1>
    ...
    <form action="{{ route('admin.pelanggans.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nama_pelanggan" name="nama_pelanggan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('nama_pelanggan') border-red-500 @enderror" value="{{ old('nama_pelanggan') }}" required autofocus>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nomor_kwh" name="nomor_kwh" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('nomor_kwh') border-red-500 @enderror" value="{{ old('nomor_kwh') }}" required> {{-- <-- Ganti name/id --}}
